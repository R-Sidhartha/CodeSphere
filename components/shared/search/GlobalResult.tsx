...
const GlobalResult = () => {
    ...
    const [result, setResult] = useState([
        ...
        { type: 'tag', id: 2, title: 'tag' },
        { type: 'user', id: 3, title: 'secsdc' },
    ]);
    ...
    useEffect(() => {
        if (!global) {
            setResult([]); // Clear results when there is no query
            return;
        }
            ...
            <div className='space-y-5'>
                ...
                {isLoading ? (
                    <div className='flex-center flex-col px-5'>
                        ...
                        <p className='text-dark200_light800 body-regular'>Browsing the entire website</p>
                    </div>
                ) : (
